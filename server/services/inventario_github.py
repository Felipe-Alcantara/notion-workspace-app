"""Compatibilidade para `services.inventario_github` consolidado no `notion_starter`."""
...
try:
    _modulo = importlib.import_module("notion_starter.services.inventario_github")
